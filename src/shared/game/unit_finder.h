...
namespace wowpp
{
	...
	public:
		...
		///
		const proto::MapEntry &getMapEntry() const {
			return m_map;
		}
		///
		/// @param findable
		...
		///
		/// @param shape
		virtual std::unique_ptr<UnitWatcher> watchUnits(const Circle &shape, std::function<bool(GameUnit &, bool)> visibilityChanged) = 0;
