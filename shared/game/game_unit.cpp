...
namespace wowpp
{
	...
	void GameUnit::initialize()
	{
		...
		setUInt32Value(unit_fields::BoundingRadius, 1.080510020256f);		//UNIT_FIELD_BOUNDINGRADIUS		(TODO: Float)
		setUInt32Value(unit_fields::CombatReach, 0.90042400360107f);			//UNIT_FIELD_COMBATREACH		(TODO: Float)
