...
namespace wowpp
{
	...
	private:
		...
		boost::signals2::scoped_connection m_casterDespawned, m_targetMoved, m_targetEnteredWater, m_targetStartedCasting, m_dismountOnCast, m_onExpire, m_onTick, m_onTargetKilled;
