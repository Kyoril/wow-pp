...
namespace wowpp
{
	namespace editor
	{
		...
		Ogre::DataStreamPtr BLPCodec::code(Ogre::MemoryDataStreamPtr& input, Ogre::Codec::CodecDataPtr& pData) const
		{        
		...
		void BLPCodec::codeToFile(Ogre::MemoryDataStreamPtr& input,
