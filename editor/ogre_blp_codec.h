...
namespace wowpp
{
	namespace editor
	{
		...
		public:
			...
			Ogre::DataStreamPtr encode(Ogre::MemoryDataStreamPtr& input, Ogre::Codec::CodecDataPtr& pData) const override;
			/// @copydoc Ogre::Codec::codeToFile
			void encodeToFile(Ogre::MemoryDataStreamPtr& input, const Ogre::String& outFileName, Ogre::Codec::CodecDataPtr& pData) const override;
