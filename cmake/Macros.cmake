function(enable_unity_build UB_SUFFIX SOURCE_VARIABLE_NAME)
	...
	if(fileCount GREATER 2)
		...
		foreach(loop_var RANGE 0 ${file_end} ${WOWPP_UNITY_FILES_PER_UNIT})
			...
			set(file_index 0)
			math(EXPR min_file "${unity_index}*${WOWPP_UNITY_FILES_PER_UNIT}")
			math(EXPR max_file "${min_file}+${WOWPP_UNITY_FILES_PER_UNIT}+1")
